...
@Autonomous(name = "Blue 24 Gate Cycle")
public class CloseZoneGateCycleBlueFast extends TaskOpMode {
    @Override
    public Jobs spawn() {
        ...
        Position gateIntake = new Position(1890 + xOffset, -40 + yOffset, 150);
